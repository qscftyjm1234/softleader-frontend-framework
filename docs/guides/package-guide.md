...
- **ESLint/Prettier**: 統一程式碼風格,提升可維護性
- **Git 工具**: 確保 Commit 訊息規範,方便版本追蹤

### Q2: 可以移除某些套件嗎?

**A**: 可以,但建議保留標示為「必須」的套件。可選套件可依專案需求決定是否安裝。

### Q3: 安裝失敗怎麼辦?

**A**: 請依序檢查:

1. Node.js 版本是否符合 (建議 v18.0.0+)
2. npm 版本是否為最新
3. 網路連線是否正常
4. 清除快取後重試: `npm cache clean --force`
