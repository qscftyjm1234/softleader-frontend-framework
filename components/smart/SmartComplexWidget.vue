  ...
  >
    ...
    <div class="pa-6 pb-0 d-flex align-center justify-space-between">
      ...
      <v-avatar color="blue-lighten-5" size="48" rounded="lg">
        <v-icon icon="mdi-chart-timeline-variant" color="blue-darken-2" size="24"></v-icon>
      </v-avatar>
    </div>
    ...
    <v-card-text class="pa-6">
      ...
      <div class="mb-3 d-flex align-center">
        ...
        <v-chip size="x-small" color="blue-grey" variant="flat" class="ml-2 font-weight-bold">
          {{ history.length }}
        </v-chip>
      </div>
        ...
        <v-slide-y-transition group>
          ...
          >
            <div class="d-flex flex-column mr-3">
              <v-icon icon="mdi-circle-small" color="green-darken-1" size="small"></v-icon>
            </div>
